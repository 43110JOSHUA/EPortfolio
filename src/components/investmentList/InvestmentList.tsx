    ...
    <>
      <div className="bg-light-tan border border-light-grey rounded-4 p-4 p-lg-5">
        <div className="d-flex justify-content-center align-items-center gap-3 pb-4">
          <h4 className="fw-bold mb-0">My Investments</h4>
        ...
        <div className="d-flex flex-column gap-3">
          ...
          <small className="text-center text-secondary">
            Note: Stock prices are currently being fetched directly from
            frontend for speed (free Azure backend goes to sleep if inactive).
          </small>
        </div>
      </div>
    </>
